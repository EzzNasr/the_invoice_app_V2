...
![Process 1 - Bill Type & Overview](docs/flowchart-process1.svg)

![Process 2 - Pricing & Cart](docs/flowchart-process2.svg)

![Process 3 - DB Write & Document Generation](docs/flowchart-process3.svg)
